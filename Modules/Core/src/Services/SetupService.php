...
class SetupService extends BaseService
{
    ...
    public function upgrade006120()
    {
        ...
        if (session()->get('is_upgrade') && $upgrade_diff > 100 && $versions[1]->version_date_applied > time() - 100) {
    ...
    public function upgrade029156()
    {
        ...
        // Copy the invoice pdf footer to the new quote pdf footer setting$this->mdl_settings->loadSettings();$this->mdl_settings->save('pdf_quote_footer', get_setting('pdf_invoice_footer'));
    }
