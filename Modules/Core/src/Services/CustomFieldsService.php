...
class CustomFieldsService extends BaseService
{
     ...
     *
     * @return \Modules\Core\Models\CustomField[] an array of CustomField model instances matching the provided table
     */
    public function getByTable($table)
    {
        return \Modules\Core\Models\CustomField::query()
    ...
    public function delete($id): bool
    {
        if ( ! $this->used($id)) {
            ...
            if (preg_match('/CHOICE/', $custom_field->custom_field_type)) {$this->mdl_custom_values->deleteAllFid($id);
            }
