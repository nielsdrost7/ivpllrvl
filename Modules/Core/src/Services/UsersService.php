...
class UsersService extends BaseService
{
    ...
    public function dbArray()
    {
        ...
        if (isset($db_array['user_password'])) {
            unset($db_array['user_passwordv']);$user_psalt                = $this->crypt->salt();
    ...
    public function save($id = null, $db_array = null)
    {
        ...
        if ($user_clients = session()->get('user_clients')) {foreach ($user_clients as $user_client) {
    ...
    {
        parent::delete($id);delete_orphans();
    }
}
