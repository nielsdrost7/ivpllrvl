...
class DashboardControllerTest extends AbstractTestCase
{
    ...
    {
        Payment::factory()->count(4)->create(['quote_status_id' => 1]); // Draft
        Payment::factory()->count(2)->create(['quote_status_id' => 2]); // Sent
        Payment::factory()->count(3)->create(['quote_status_id' => 3]); // Approved
